...
class MhrsAutomation:
    ...
    def start_old(self):
        telegram = Telegram(api_id=24406313, api_hash="fc75edf735fb81f09833aae5da5ed2ee", bot_token="5816578922:AAHyIKu5Tctd4IUlDtfAtsViW8q7E979D1Y")
        telegram.login()
    ...
    async def main(self):
        ...
        self.telegram = Telegram(api_id=24406313, api_hash="fc75edf735fb81f09833aae5da5ed2ee", bot_token="752121353372121AAEDWML321Lx2KoBAP6RD-MJncsKIBLfWaPUQw", localDatabase=localDatabase)
        await self.telegram.login()21
